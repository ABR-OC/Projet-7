...
window.addEventListener('load', async () =>{
    ...
    /* Selon status de l'utilisateur , permet de rendre visuellement le message */
    ...
    if (postUserId === userId) { // L'utilisateur a créé le post
        ...
        /* Permet d'afficher l'image si un nouveau fichier est sélectionné */
        ...
        /* Permet de modifier le message de l'utilisateur */
        updateBtn.addEventListener('click', async (e) => {
            ...
            await updateFormData(urlPost, formData) // Modifie la ou les donnée(s) de l'utilisateur et les envoie au serveur
